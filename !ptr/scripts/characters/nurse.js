...
var logbook = {
	...
	artist: "Oreteki18kin<br>Original Image Set: Daiji na Koto wa Daitai Onee-chan ga Oshietekuremashita.",
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "intro2A", name: "Enter the school's ward", location: 'westHallway', time: "MorningEvening", itemReq: "", trustMin: 1, trustMax: 2, type: "tab", top: 0, left: 0, day: "both", altName: "", altImage: "",},
	...
	switch (name) {
		...
		case "potionQuo": {
			...
			if (checkTrust('fitboi') == 80 && checkFlag("fitboi", "cream") == false) {
				writeFunction("writeEncounter('nurseCream')", "It seems like nurseF has a new creation");
			}
		...
		case "nurseCream": {
			writeHTML(`
				...
				nurse This is one of my older mixtures, actually. There we a bunch of warnings on the recipe page, 'Do not create', all that. I can't figure out why.
				player And you made it anyways?
				nurse Of course! I diluted it down to a fraction strength, so it should be safe. It's a topical cream meant for skincare, although I think I called it... She-cream. I'm not sure why, according to my notes the name came to me in a dream.
				player Spooky. What's it do?
				nurse Well, on my skin it just gives me a nice tingle. If my formulae are correct though on a man it'll cause precum generation to spike by a frankly unreasonable percent, and if applied to the prostate...<br>Well, I've diluted the formula. It should be entirely fine for you to use, and if you find a good target for it's use then it should leave them a veritable putty in your hands!
				player I see, I'll use it wisely then.
				nurse Ah, be careful though. If used in tandem with any other... Effeminizing effects, the two will have a compounding effect.
				player Meaning?
				nurse Meaning there won't be anything left of them as a person. It might be a similar reaction to the blonding potion. Again, no proper warnings. Please be detailed when you recount it's effects so I can log them for the next time I lose my memories. 
			`);
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		...
		case "nurseBath": {
			...
			writeText("...");
			writeText("You were hoping for her to be a bit more direct with a reward for your efforts, but the moment you sink into the warm bathwater your cares and exhaustion simply fade away.");
			...
			writeSpeech("nurse", "", "I'd... My, I'd want nothing to do with you... I'd have to be a pervert beyond any hope of redemption, someone who'd want nothing more than to fulfill my <i>purpose in life</i> with you. That's the sort of person I'd have to be to stay in this bath.<br>But of course, I have self control. I'm <i>not</i> fantasizing about what that perfect member would feel like inside me, and I'm certainly not getting wet... At the thought...<br>At the thought of bathing. In. Your. <b>Cum</b>~!");
