...
var logbook = { //Logbook details for each character.
	...
	artist: "Nagi Ichi<br>Original Image Set: Aitsu no Toriko ni Natta Boku",
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "tomgirlHotelBad", name: "Ask about tomgirl", requirements: "?flag demon hotelBad; ?trust tomgirl 666;", altName: "", altImage: "",},
	{index: "tomgirlHotelGood", name: "Search for tomgirl", requirements: "?flag succubus hotelGood; ?trust tomgirl 666;", altName: "", altImage: "",},
]
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "tomgirlHotelBad": {
			writeHTML(`
				define black = sp Black Haired Succubus; im images/demon/dark.jpg;
				black Ah, the tomgirl. He was... Certainly full of spunk when we found him. He was resistant at first to fucking anyone but you, but... Well... demonF was very clear that all new whores get a proper training period. Here.
				im 056.jpg
...
switch (requestType) {
	case "test": {
			//writeText("test");
			addEncounter("tomgirl", "statusQuo", "Enter Midnight Bliss")
