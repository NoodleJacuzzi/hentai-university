...
var logbook = {
	...
	artist: "Enoshima Iki<br>Original Image Set: Sunao de Otonashikute Mucchimuchi na Imouto no Love Love Hatsujouki",
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		...
		case "neetA-1-2": {
			...
			writeText("Carefully you pull out, the only sound between you is the wet squish of flesh on flesh.");
