...
var logbook = {
	...
	artist: "Kinta no Mousou<br>Original Image Set: Otokonoko to Himitsu no Kankei",
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	{index: "intro0", name: "A student still in class catches your eye through the window", requirements: "?trust nagatoro 0; ?location westHallway;", altName: "", altImage: "",},
	{index: "setup1A", name: "nagatoro is here.", requirements: "?trust nagatoro 40; ?location westHallway; ?time Evening;", altName: "", altImage: "",},
	{index: "setup2A", name: "nagatoro is here.", requirements: "?trust nagatoro 41; ?location westHallway;", altName: "", altImage: "",},
	...
	{index: "nagatoroComfort1", name: "You think you see nagatoro out the window", requirements: "?trust nagatoro 99; ?location westHallway;", altName: "", altImage: "",},
	{index: "clubEntrance", name: "The clubroom is here", requirements: "?trust nagatoro 100; ?location westHallway;", altName: "", altImage: "",},
	{index: "clubQuo", name: "The clubroom is here", requirements: "?trustMin nagatoro 101; ?location westHallway;", altName: "", altImage: "",},
	{index: "nagatoroHotelBad", name: "Ask about nagatoro", requirements: "?flag demon hotelBad; ?trust nagatoro 666;", altName: "", altImage: "",},
	{index: "nagatoroHotelGood", name: "Search for nagatoro", requirements: "?flag succubus hotelGood; ?trust nagatoro 666;", altName: "", altImage: "",},
];
	...
	switch (name) {
		...
		case "intro0": {
			writeHTML(`
				...
				sp Student; im images/none.png; nagatoroF, are you really still going on about that club? There's no way you'll get permission.
		...
		case "intro1": {
			writeHTML(`
				...
				sp nagatoro; Aww, cmon. You'd get to spend as much time with me as you want after classes, and I have plenty of really cute outfits I bet you'd love to see me try out.<br>Plus, helping students to be honest with themselves? Your 'reputation' would be one of openness and compassion. And all the experienced faculty, minus the witch who teaches psychology of course, are advising a club already. It'd make you look pretty good in the principal's eyes I bet.<br>Pleeeeease?
			`);
		...
		case "setup1A": {
			writeHTML(`
				...
				t He says it so nonchalantly, but you're suspicious he's got a trap planned. Still, his idea of a trap is probably just an excuse for more teasing.
			`);
		...
		case "nagatoroComfort1": {
			...
			writeHTML(`
				...
				sp nagatoro; ?gender male; Listen, teasing you is fun, but you're some nobody counselor. No offense, but I don't think you're sticking around. Male faculty never do here. Messing with you compared to messing with her or anybody else, it's a whole different thing. 
				sp player; ?gender male; What if I could help you with that? What if I could help you be your real self whenever you wanted? 
				...
				sp player; ?gender woman; What if I could help you with that? What if I could help you be your real self whenever you wanted? 
		...
		case "yokaiJoin": {
			writeHTML(`
				t You call yokaiF to your location. He floats through the wall, looking around the school curiously, before he puts on his usual face.
				yokai Hmph, for you to summon me here, surely it's to admit defeat? I recognize these garments, they are for this era's women. Scandalous, I will say, but-
				nagatoro playerF! Good morning!
				player Morning nagatoroF. Here to try out something?
				nagatoro From here? Pfft, nah.
				yokai Hum hum, looks like-
				nagatoro I've got a shipment coming in today! Hey, you ever wanted to see what I'd look like in kitty-cat bra?
				t yokaiF's jaw drops as nagatoroF pulls his collar just barely to show what he's wearing beneath his shirt. 
				nagatoro Hehe, pervy counselor... Eh, hey, do you feel like we're being watched?
				t ...
				yokai Fine, but that was mere coincidence.
				player Looks like another club member is coming in. 

				t ?flag tomgirl club; tomgirlF steps into the clubroom. He looks almost bored until he sees you.
				tomgirl playerF? ?flag tomgirl club; Oh wow! I didn't know you'd be supervising today! Hey, nagatoroF's black bunny outfit, do you think it'd- 

				t ?flag meji club; mejiF enters the clubroom, checking to make sure he wasn't followed.
				meji ?flag meji club; playerF? Uh, I thought today would be a normal meeting. 

				t ?flag succubus club; succubusF, in disguise, steps inside seeming to blend in with the background. He looks pretty bored until he notices you.
				succubus ?flag succubus club; ... I, I, uh.<br>W-wow, *Master! Heeeey! I knew you'd be here, I wasn't invited by nagatoroF or anything, haha...<br>Eh? Who's that-
				t ?flag succubus club; succubusF's eyes go even wider and he makes a mad dash out of the room, pretending he didn't see anything. 

				yokai N-no... How could this be? I could believe that there'd be one, albeit that was hard to swallow, but...
				t As yokaiF searches for the words, you hold up a few outfits that are probably his size.
				yokai Ghh... M-my pride shall not break from this. If mere humans can bear with this demeaning fashion, then I can as well. Do your worst, human, I shall surpass this trial with my dignity intact. 
			`);
			addFlag("yokai", "club");
			writeFunction("writeEncounter('clubQuo')", "Continue");
			break;
		...
		case "nagatoroHotelGood": {
			writeHTML(`
				im images/nagatoro/hotelAdmire.jpg
		...
		case "nagatoroHotelBad": {
			writeHTML(`
				im images/nagatoro/hotelBad.jpg
...
var phoneArray = [//Lists the potential text events the player can receive at the start of the day, depending on their trust.
	{index: "reward", requirements: "?trust nagatoro 104;"},
	{index: "rewardCorrupt", requirements: "?trust nagatoro 666;"},
]
...
function writePhoneEvent(name) { //Plays the relevant phone event
	...
	switch (name) {
		...
		case "rewardCorrupt": {
			...
			writePhoneSpeech("nagatoro", "", "You've primed nagatoroF for transformation into a succubus (male)!");
...
function openWardrobe() {
	...
	if (checkFlag("succubus", "club") == true) {
		...
		if (checkFlag("nagatoro", "succubusIntro") != true) {
			specialEvent = "succubusJoin";
		}
	}
	if (checkFlag("yokai", "club") == true) {
		writeWardrobeOption("yokaiClub1");
		writeWardrobeOption("yokaiClub2");
	}
	if (checkFlag("son", "club") == true) {
		clubSize += 1;
		writeWardrobeOption("sonClub1");
		if (checkFlag("son", "club1") == true) {
			writeWardrobeOption("sonClub2");
		}
	}
	if (checkFlag("yokai", "gambled") == true && clubSize > 1 && checkFlag("yokai", "club") != true) {
		specialEvent = "yokaiJoin";
	}
	if (checkFlag("intern", "club") == true) {
		writeWardrobeOption("internClub1");
		writeWardrobeOption("internClub2");
	}
	if (checkFlag("serious", "club") == true) {
		clubSize += 1;
		writeWardrobeOption("seriousClub");
	}
	if (specialEvent != "") {
		writeEncounter(specialEvent);
	}
}

function writeWardrobeOption(wardrobeImage) {
	if (checkFlag("nagatoro", "blue") == true) {
		var imageFolder = "nagatoroBlue";
	}
	else {
		var imageFolder = "nagatoro";
	}
	if (wardrobeImage.includes("Locked")==false) {
		document.getElementById('wardrobeGrid').innerHTML += `
			<img class="bigPicture" id="`+wardrobeImage+`" src="images/`+imageFolder+`/`+wardrobeImage+`.jpg" 
