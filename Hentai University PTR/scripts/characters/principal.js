...
var logbook = { //Logbook details for each character.
	...
	artist: "Oreteki18kin<br>Original Image Set: Mama to Hame Chao!! Mama Man Cho! & Mama to Hame Chao!! Mama Man Cho! Natsu",
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "principalCheckup", name: "Check on principal's corruption", requirements: "?location sepia-schoolEntrance; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
	{index: "principalOval", name: "principal has a powerful memory of a friend here", requirements: "?location sepia-westHallway; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
	{index: "principalSharp", name: "principal has a powerful memory of a friend here", requirements: "?location sepia-teacherLounge; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
	{index: "principalMolested", name: "principal has a powerful memory of a strange event here", requirements: "?location sepia-westHallway; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
	{index: "principalPhysical", name: "principal has a powerful memory of strange event here", requirements: "?location sepia-gym; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
	{index: "principalTeaching", name: "principal has a powerful memory of her early teaching career here", requirements: "?location sepia-classroomA; ?flag principal oldSchool;", altName: "", altImage: "images/pink/pink.jpg",},
];
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	writeHTML(`
		...
		define pink = sp principal; im images/pink/pink.jpg; altColor #FFB4B1;
		define oval = sp Maddy; im images/pink/kind.jpg; altColor  #D4DCDF;
		define sharp = sp Kendra; im images/pink/mean.jpg; altColor #4A4996;
	`);
	switch (name) {
		case "cancel": {
		...
		case "introduction1": {
			if (data.player.carnivore != true) {
				...
				writeHTML(`
					t The door to principalF's office is closed, although her secretary is here reading a book titled "Getting Your Act Together." It's well worn.
					player Excuse me, is principalF in? I'm playerF, I'm the new hire.
					secretary Yes! Yes she is, go right on ahead.
				`);
			}
		...
		case "introduction2": {
			...
			if (data.player.carnivore != true) {
				...
				writeHTML(`
					principal Yes, of course. Now, it says here you specialize with male students?
					player Correct.
					principal I see, very good then. We have quite a few troubled souls attending this term. Some showing signs of delinquency, obesession with innapropriate attire, so on.<br>I've heard from some of my security staff that some students have even been found in town...
					t She leans forwards and lowers her voice to a whisper.
					principal ... Loitering.
					player How horrifying.
					principal Of course! Now, I don't want to put undo pressure on you, there's no need for regular reports. I suggest you spend time around Classroom A, that's where the majority of our male students are taking classes this term.
					player I'll do that then. It was good meeting you.
					principal And you.
					t She seems relaxed around you, probably a lot more trusting since you seem less likey to cause some kind of scandal, what with you only working with boys.
					t So long as you don't do anything to crazy, you should have the run of the place. 
				`);
			}
			passTime();
		...
		case "caseSelect": {
			...
			if (checkFlag("principal", "council") == true) {
				...
				switch (presidentStatus) {
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished corrupting presidentF.
						`);
						break;
					}
					case "corrupt": {
					...
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted presidentF.
						`);
					}
				}
				var nurseStatus = "";
				...
				switch (nurseStatus) {
					...
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished corrupting nurseF.
						`);
						break;
					}
					case "corrupt": {
					...
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted nurseF.
						`);
					}
				}
				var scarfStatus = "";
				...
				switch (scarfStatus) {
					case "challenging": {
						writeHTML(`
							...
							t scarfF <b>isn't on your side yet</b>.
						`);
						break;
					}
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished fully corrupted scarfF.
						`);
						break;
					}
					case "corrupt": {
					...
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted scarfF.
						`);
					}
				}
				var mamaStatus = "";
				...
				switch (mamaStatus) {
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished corrupting mamaF.
						`);
						break;
					}
					case "son": {
					...
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted mamaF.
						`);
					}
				}
				var ojouStatus = "";
				...
				switch (ojouStatus) {
					...
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished corrupting ojouF.
						`);
						break;
					}
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted ojouF.
						`);
					}
				}
				var pinstripeStatus = "";
				...
				switch (pinstripeStatus) {
					...
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> finished corrupting pinstripeF.
						`);
						break;
					}
					default: {
						writeHTML(`
							...
							t You have <b>not</b> corrupted pinstripeF.
						`);
					}
				}
				...
				switch (instructorStatus) {
					...
					case "met": {
						writeHTML(`
							...
							t You have <b>not</b> corrupted instructorF.
						`);
						break;
					}
					default: {
				...
				if (numberCorrupted == 7) {
					writeSpecial("Every member of the PTSA has been corrupted! Something special will happen soon.");
				}
				else {
			...
			if (checkTrust("gilf") == 90) {
				writeFunction("writeEncounter('gilfTalk')", "Ask about her last name");
			}
		...
		case "gilfTalk": {
			writeHTML(`
				principal My last name? Well, it's not a common one. My family actually established this school many years ago, although...
				player Although?
				principal My great grandfather was a man of his time. He had a mind to exclude certain people from this place, and the town back then agreed with him. It's not a badge the university wears with pride. You can find more in the school library, although some details were scrubbed out by my predecessor.
		...
		case "subtleEpilogueEntrance": {
			writeHTML(`
				...
				t But at the front entrance, and through the classroom windows, sights and sounds she hoped never to hear are plainly visible.
				im purple.jpg
		...
		case "subtleEpilogueAftermath": {
			addFlag("principal", "endingSubtle");
			writeHTML(`
		...
		case "blackmailSuccess": {
			...
			`);
			writeFunction("writeEncounter('blackmailFollowupNew')", "Continue");
			break;
		}
		case "blackmailFollowupNew": {
			writeHTML(`
				president So... What will you actually <i>do</i> with her?
				scarf She was under so much stress that she passed out, but with a will like hers it's unlikely she's completely broken.
				nurse We chose the brute force strategy, if we can't completely bend her to our will after this, we'll have a tough time on our hands once she's awake again.
				president But if we can, we'll have a powerful ally if we want to extend our reach beyond the school.
				scarf I think while she's asleep we should put her into a trance. We can start to use suggestion to tweak her memories, find exactly what makes her the sort of principal she is, and twist those until she's more... Agreeable, to our cause.
				player And how exactly are we going to do this?
				scarf Hypnosis.
				nurse Drugs!
				president Creativity?
				instructor Gumption!
				player ... I get the impression that some of you are going to be more helpful than others.
				t ...
				t After a great deal of planning, and more than a little squabbling, a plan born from teamwork is born. You're handed a vial by nurseF, given a spot to lay down, and scarfF and presidentF take a seat on either side of the unconcious principalF.
				president Alright, here's the plan. scarfF and I will guide principalF through her trance and her memories.
				nurse And the vial I gave you will put you into an addled state where you'll be able to visualize all of her ramblings.
				scarf And we and the rest of our little crew will make suggestions to principalF based on how you feel we should proceed.
				nurse It'll be like you'll be right there in her memories!
				scarf And of course the techniques I showed you in my challenge ought to help with that.
				player This is really pushing the limits of what can be counted as hypnosis...
				instructor Well, if it works, it works, right? I can't go back to my old teaching style.
				mama And to tell the truth... I Really hope to see what the school will be like once principalF comes around to our way of seeing things.
				player ... Alright then, bottoms up.
				t You take a swig and lie down, the mixture taking effect pretty immediately, your vision swirls with a blend of colors that pop in and out of reality, eventually forming semi-solid shapes as you hear voices all around you.
				principal I was... I was so excited for my first day... Well, maybe terrified would have been a better word for it...
			`);
			writeFunction("writeEncounter('oldSchoolStart')", "Continue");
			break;
		}
		case "oldSchoolStart": {
			writeHTML(`
				im images/pink/001.jpg
				pink Alright, I can do this! 
				t You're outside and older version of the school, a younger principalF is hyping herself up for her first day as a teacher
				president playerF, are you alright? Her memories will be unfocused, so feel free just to acquaint yourself with her and the area before we proceed. 
				scarf After you're familiar with the environment we'll start altering her memories and come back when we want to wrap up.
				president But remember, playerF. She'll only remember people who were influental or important to her. You'll have to play the part of everyone else.
				scarf This is a dream of sorts, so you should have no problem playing multiple actors, yes?
				player I guess. Let's get this started.
			`);
			setTrust("principal", 41);
			addFlag("principal", "oldSchool");
			writeFunction("changeLocation('sepia-schoolEntrance')", "Begin");
			break;
		}
		case "principalCheckup": {
			switch (true) {
				case (checkTrust("principal") < 43): {
					writeHTML(`
						president Let me see...
						president It seems like she's barely been changed at all. I don't think we should wake her up like this.
					`);
					break;
				}
				case (checkTrust("principal") < 46): {
					writeHTML(`
						president Let me see...
						president She's changed a bit, but most of her core ideology is the same. She might turn a blind eye to our behavior once she's awake, but I think we should go farther.
					`);
					break;
				}
				case (checkTrust("principal") < 52): {
					writeHTML(`
						president Let me see...
						president Her core philosophies are heavily muddled, with enough convincing, and maybe a little dicking, we can win her over completely to our cause. Should we stop here?
						trans blackmailFinaleNewMed; Finish here
					`);
					break;
				}
				default: {
					writeHTML(`
						president Let me see...
						president She's... Completely different.
						scarf No more than a gutter whore at this point, honestly.
						nurse Ooh, maybe once she's awake I could use her as a test subject!
						instructor Or maybe have her clean my girls' bodies after their workouts!
						president Honestly, those would probably work better than having her become our ally. I don't think there's anything more we should, or can do now.
						trans blackmailFinaleNewHigh; Finish here
					`);
				}
			}
			writeFunction("changeLocation('sepia-schoolEntrance')", "Go back");
			break;
		}
		case "principalOval": {
			switch (true) {
				case (checkFlag("principal", "principalOvalIntro") != true): {
					writeHTML(`
						pink Maddy!
						im images/pink/018.jpg
						principal She was... So kind. Everyone felt like she was so approachable, it was like she could make friends with anyone. When we first met she was talking casually with a scary-looking delinquent like they were family, but it turns out they'd never met before... I wanted to know...
						pink How do you connect with them so well? The students, I mean. N-not that I think you're connecting with others, err-
						oval You're too worried, it shows on your face. If you're open and inviting, and greet people with a smile, it'll put even the most hardened of hearts at ease.
						pink An open and inviting smile...
						oval Here, why not sit in on my next talk?
						president Hrm... It seems like Maddy helped define principalF's approachable attitude. We could make up a new memory, something that undermines that approachable nature...
						finish
					`);
					addFlag("principal", "principalOvalIntro");
					break;
				}
				case (checkFlag("principal", "principalOval1") != true): {
					writeEvent("principalOval1");
					addFlag("principal", "principalOval1");
					writeHTML(`
						finish
					`);
				...
				case (checkFlag("principal", "principalOval2") != true): {
					writeEvent("principalOval2");
					addFlag("principal", "principalOval2");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				default: {
					writeHTML(`
						im images/pink/017.jpg
						pink Maddy...
						president That ought to be enough. I wonder if principalF could help us find her old friends once she's up and about again?
						scarf Don't lose focus. playerF, I think we're finished here. Don't linger too much, having presidentF linger on corrupted memories will deteriorate her mind further, we could overshoot our goal.
						president Indeed. Intervening once, maybe twice should be enough for each core memory.
						finish
					`);
					raiseTrust("principal", 1);
				}
		...
		case "principalSharp": {
			switch (true) {
				case (checkFlag("principal", "principalSharpIntro") != true): {
					writeHTML(`
						pink Kendra!
						im images/pink/020.jpg
						principal She was... Incredible. She could take control of any situation, no matter how rowdy the crowd was. I wanted to know...
						pink How'd you get so confident as a teacher?
						sharp The secret is to draw the line firmly, and stay consistent. You're too much of a pushover.<br>And fix your hair already! This is a place of prestige, if you can't take care of your appearance and health, you set a bad example for everyone around you!
						pink Eep! Sorry!
						sharp Hey, you there! That jacket's far too gaudy for regulation!
						im images/pink/021.jpg
						sharp If you can't follow the rules, then don't act surprised when items get confiscated!
						pink ...!
						mama It sounds like she learned her sense of strictness from this Kendra person. 
						scarf But it also seems like it wouldn't be too hard to change her memories and make this Kendra woman's lessons take on a different tone.
						finish
					`);
					addFlag("principal", "principalSharpIntro");
					break;
				}
				case (checkFlag("principal", "principalSharp1") != true): {
					writeEvent("principalSharp1");
					addFlag("principal", "principalSharp1");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				case (checkFlag("principal", "principalSharp2") != true): {
					writeEvent("principalSharp2");
					addFlag("principal", "principalSharp2");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				default: {
					writeHTML(`
						im images/pink/027.jpg
						pink Kendra...
						mama From how she looks, I think her memory of her friend Kendra is...
						scarf Completely twisted. Good work, playerF.
						finish
					`);
					raiseTrust("principal", 1);
				}
		...
		case "principalMolested": {
			switch (true) {
				case (checkFlag("principal", "principalMolestedIntro") != true): {
					writeHTML(`
						pink Stop, what are you doing?!
						im images/pink/003.jpg
						principal It was a different time, but still... I remember they grabbed me once, I guess they wanted to try and make me more of a pushover, not like Maddy or Kendra... 
						pink Let me go you... Hoodlums!
						principal Kendra came to my rescue, and the students were expelled, but-
						scarf Did she really save you?
						president You might not be remembering that right.
						principal I... I don't...
						nurse This might be a pretty important event for her! We just need to push this one farther!
						finish
					`);
					addFlag("principal", "principalMolestedIntro");
					break;
				}
				case (checkFlag("principal", "principalMolested1") != true): {
					writeEvent("principalMolested1");
					addFlag("principal", "principalMolested1");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				case (checkFlag("principal", "principalMolested2") != true): {
					writeEvent("principalMolested2");
					addFlag("principal", "principalMolested2");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				default: {
					writeHTML(`
						im images/pink/013.jpg
						pink Ugh...
						nurse Ah, it sounds like our job's done here. I don't think even I could twist this memory any farther.<br>Unless...
						instructor nurseF, put down the syringe!
						president We should probably move on from here.
						finish
					`);
					raiseTrust("principal", 1);
				}
		...
		case "principalPhysical": {
			switch (true) {
				case (checkFlag("principal", "principalPhysicalIntro") != true): {
					writeHTML(`
						pink Mmmmrr... This is embarassing...
						im images/pink/030.jpg
						principal It was so stupid and crude, the old principal was horrid... We dressed up in spare gym outfits, hoping to "build team morale"... It was humiliating...
						oval Cheer up! All we need to do is smile and wave!
						sharp And relax, they may have pushed us to wear these, but if anyone actually tries anything...
						oval And after today we'll have solid evidence that the head is abusing their position.
						pink You guys... I know you're just putting on a strong face for me... 
						instructor Aha! So she ended up in a situation like that, and the feeling of shame stuck with her! Well, playerF taught me a great way to overcome that shame. We can alter her memories and have her more enthusiastically build some school spirit!
						finish
					`);
					addFlag("principal", "principalPhysicalIntro");
					break;
				}
				case (checkFlag("principal", "principalPhysical1") != true): {
					writeEvent("principalPhysical1");
					addFlag("principal", "principalPhysical1");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				case (checkFlag("principal", "principalPhysical2") != true): {
					writeEvent("principalPhysical2");
					addFlag("principal", "principalPhysical2");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				default: {
					writeHTML(`
					im images/pink/040.jpg
					pink A-again...?!
					president instructorF, principalF's memory here has already been completely degredated. there's nothing more we need to do here.
					instructor But, but...
					player You hear how sad she sounds? Have a heart, presidentF.
					president ... Fine.
					t ...
					im images/pink/049.jpg
					pink Ouuugh...
					president Satisfied?
					`);
					writeDual("player", "", "instructor", "", "Very.");
					writeHTML(`
					finish
					`);
					raiseTrust("principal", 1);
		...
		case "principalTeaching": {
			switch (true) {
				case (checkFlag("principal", "principalTeachingIntro") != true): {
					writeHTML(`
						pink And so, any other questions? Don't be shy!
						im images/pink/051.jpg
						principal I gave it my all every day, I started blossoming as a teacher, but the students... I feel like they... Like this isn't right...
						scarf And as the foundation cracks, the bright and vivid memories of her time as a teacher are starting to collapse.
						nurse A quick dose of aphrodisiac ought to help out here.
						president And some soothing words will normalize the school becoming a debased place, right, playerF?
						finish
					`);
					addFlag("principal", "principalTeachingIntro");
					break;
				}
				case (checkFlag("principal", "principalTeaching1") != true): {
					writeEvent("principalTeaching1");
					addFlag("principal", "principalTeaching1");
					writeHTML(`
						finish
					`);
					raiseTrust("principal", 1);
				...
				default: {
					writeHTML(`
						im images/pink/060a.jpg
						president One of her most core memories is fully tainted...
						scarf We might have gone far enough already.
						president Yes. playerF, come back to the entrance, follow the sounds of our voices.
						nurse Oooor keep having fun! I have enough sedatives to put a horse under!
						president That's because those are horse sed-<br>Nevermind.
						finish
					`);
					raiseTrust("principal", 1);
				}
		...
		case "blackmailFinaleNewMed": {
			writeHTML(`
				president Alright, we're waking you up.
				instructor Rise and shine!
				nurse I have adrenaline if you need it.
				player Ugh... She's still out?
				scarf Yes. She should be waking up soon, but we decided you should be the one to do the honors.
				...
				player Good morning!
				principal Where's ev-<br>Ghh, what are you doing?!
				player Relax, we're just having a casual fling. Don't you remember?
				principal A casual-<br>I... Ugh...
				im 072.jpg
				principal Well why didn't you wake me up sooner? I appreciate the efficiency, but I can't see any reason I'd turn you down.
				player Eh, I just didn't think you losing your virginity would be that big of a deal?
				principal Virginity? But I... I'm not... Am I?
				im 073.jpg
				principal Ghhh~!
				player That sort of stuff doesn't matter anymore, does it? Just relax, let go.
				principal I... Why do I feel so...
				player Still resistant, huh? Don't you worry, we'll have plenty of time together. Hey, how about you tell me about how the school used to be? You must have had friends, right?
				principal I... Maddy... Kendra...
			`);
			setTrust("principal", 41);
			removeFlag("principal", "oldSchool");
			removeFlag("principal", "principalOval1");
			removeFlag("principal", "principalSharp1");
			removeFlag("principal", "principalTeaching1");
			removeFlag("principal", "principalMolested1");
			removeFlag("principal", "principalGym1");
			removeFlag("principal", "principalOval2");
			removeFlag("principal", "principalSharp2");
			removeFlag("principal", "principalTeaching2");
			removeFlag("principal", "principalMolested2");
			removeFlag("principal", "principalGym2");
			removeFlag("principal", "principalOvalIntro");
			removeFlag("principal", "principalSharpIntro");
			removeFlag("principal", "principalTeachingIntro");
			removeFlag("principal", "principalMolestedIntro");
			removeFlag("principal", "principalGymIntro");
			writeFunction("writeEncounter('blackmailEnding')", "Continue");
			break;
		}
		case "blackmailFinaleNewHigh": {
			writeHTML(`
				president Alright, we're waking you up.
				instructor Rise and shine!
				nurse I have adrenaline if you need it.
				...
				t There's so much to do, there'll never be enough time. But you're the type to appreciate the journey <i>and</i> the destination.
				im 070.jpg
				t While she's still in an almost-conscious trance, you whisper the words that will seal her fate before giving her a good wake-up call.
				im 071.jpg
				principal Haaah?!<br>Wh-what's going on?!
				player Good morning!
				principal Where's ev-<br>Ghh, what are you doing?!
				player Relax. You've got a wildly different set of memories battling for your attention. I won't bother explaining it all, but the important thing is that the next time you cum the changes should sink in and all this resistance will be gone.
				principal M-memories? I... Ugh!
				im images/pink/060a.jpg
				principal I don't understand! Nggh~!
				im images/pink/040.jpg
				player Even now you feel your will fading, right?
				im 072.jpg
				principal Please... It doesn't have to be this way.
				player Excuse me?
				principal You can be better than this! Look at yourself. We could... Could be helping people! Please... Don't do this...
				t Her passionate gaze begins to drift, and her words are getting stuck in her throat.
				player You're a strange one, principalF. But it's time to finally give in.
				...
				t Through clenched teeth she groans. Hot flashes in her body, words she's ready to scream fade away before they reach her tongue. By the time her orgasm fades she looks like she only barely recognizes the room she's in.
				principal Not... Not right...
				player Still resistant, huh? I guess scarfF was off. Don't you worry, we'll have plenty of time together.
			`);
			setTrust("principal", 41);
			removeFlag("principal", "oldSchool");
			removeFlag("principal", "principalOval1");
		...
		case "blackmailEnding": {
			writeHTML(`
				t After a great deal of time has passed...
				t You open the door and presidentF steps inside.
				president Everything's going smoothly. It turns out that most people in high places don't run their ships as cleanly as principalF did. Ah, did I interrupt?
		...
		case "blackmailEpilogue": {
			addFlag("principal", "endingBlackmail");
			writeHTML(`
...
var eventArray = [ //Lists the events of the character for unlocking and replaying in the gallery.
	...
	{index: "principalOval1", name: "Maddy Manipulation 1"},
	{index: "principalOval2", name: "Maddy Manipulation 1"},
	{index: "principalSharp1", name: "Kendra Manipulation 1"},
	{index: "principalSharp2", name: "Kendra Manipulation 2"},
	{index: "principalPhysical1", name: "Gym Manipulation 1"},
	{index: "principalPhysical2", name: "Gym Manipulation 2"},
	...
	switch (name) {
		case "principalManipulation": {
			writeHTML(`
				...
				...
				t As you walk out you feel a hand grope your ass and principalF whispers into your ear, brazenly massaging you.
		...
		case "principalOval1": {
			writeHTML(`
				im images/pink/018.jpg
				president So, you took her up on her offer, right?
				principal No, I was too nervous at the time, but curiosity got the best of me, and-
				president Say no more, let me help you remember what happened.
				t ...
				pink Maddy? Are you...<br>Is she not in her office? But she said she'd be talking with a student...
				president The room was empty, but faint sounds were coming from somewhere, leaving poor little principalF lost and confused...
				pink Maddy?
				oval In here, principalF!
				pink Oh, the bathroom? I'm sorry, I'll-
				oval No it's fine, come in, I wanted to show you something.
				pink Oh, is it the new automatic sink? Those really are quite handy, although I sometimes think that-
				im images/pink/054.jpg
				pink M-MADDY?!
				oval principalF, you were wondering how I connect with students so well?
				pink This-<br>This isn't what I-
				oval It's important for students to feel appreciated. This good *boy has just been feeling lonely, so...
				im images/pink/055.jpg
				oval It's only right to let him relieve some of *his pent-up urges causing *his bad behavior, right?
				pink But Maddy, you never... This isn't right! S-sure you always seemed closer than a normal teacher, but you... Never...-
				im images/pink/056.jpg
				oval Oh my~! *His massive dick is really stirring me up!
				pink N-no!
				president You can't keep resisting. What happened next?
				principal I... I ran off...
				president Good. playerF? You're following, right? She's confused by the conflicting memory, but she's accepted it in the end.
			`);
			break;
		}
		case "principalOval2": {
			writeHTML(`
				president So, you just left her there? All alone with that student?
				principal I... N-no, I wouldn't do that...
				president That's right. I think you know you went back, maybe she was being forced? If she needed help...
				principal ...
				t ...
				pink M-maddy? Are you in?
				oval Ngh...!
				pink I'm coming in!<br>Maddy, I'm not sure what you were thinking, but-
				im images/pink/015.jpg
				pink Maddy?!
				oval Ah, principalF! I wasn't expecting you back so soon! These two young *men were just-
				pink Y-you think you're helping them, right? But this-
				oval No no no! These two were just helping me relax. It's important to take your mind off stress and anxiety through some physical activity, we need help just as much as the students do.<br>Ah, would you two mind?
				player No problem.
				im images/pink/017.jpg
				oval Ah~<br>Now, would you like a turn? These two are absolutely lovely, and you look like you could really use a nice fuck.
				pink I... I don't...
				president You were paralyzed. Your best friend, letting two students go balls-deep into her ass and pussy during broad daylight.
				principal It didn't... It doesn't make sense, why would she...?
				president playerF, we've corrupted her memory of her friend thoroughly. Let's move on, shall we?
			`);
			break;
		}
		case "principalSharp1": {
			writeHTML(`
				im images/pink/019.jpg
				scarf So, tell me more about Kendra. The two of you sound close.
				principal Well, she acted a bit cold towards students, but I know she only wanted what was best for them.
				scarf Oh? Can you tell me when you started feeling that way about her? And don't worry about the small details, I'll help you fill those in~
				t ...
				im images/pink/021.jpg
				sharp This is the last time I'll say it! You're disrupting the school's integrity! There's no place here from someone who half-asses their attire!
				player Jeez, what a bitch...
				sharp Excuse me?!
				player Er-
				scarf No, you're on the right track, just stay composed.
				player Hm... Well, sorry ma'am, it's just, well... Your outfit.
				sharp My outfit?
				pink It is... A bit revealing, Kendra.
				sharp Hmph! I see. So you're saying I'm instituting a double standard. Fine!
				im images/pink/022.jpg
				sharp There. Now you! Fix that tie, and button your shirt properly!
				pink K-kendra?!
				sharp What? If an offending piece of clothing is distracting others, it's common sense it should be removed!
				pink B-but... I...
				player That makes sense to me, ma'am.
				principal I... I don't remember... The day went calmly, I think... Why am I remembering that she would-
				scarf Oh? A beautiful woman like her spent the day without underwear while wearing a skirt so short it'd be better of as a belt, and you say the day went on without incident?
				principal W-well...
				t ...
				im images/pink/023.jpg
				sharp Every single one of you, this is disappointing! You think you can get away with walking around with massive, bulging erections? How dare you!
				player To be fair, you're the one walking around without-
				sharp Quiet!
				im images/pink/024.jpg
				pink Kendra! Why are you?
				sharp Mph! presidentF, don't undermine my punishment for these troublemakers!<br>If they refuse to act decently and control their urges, I'll have to wring out every drop of lust from their bodies!
				im images/pink/025.jpg
				sharp Glhhf!
				im images/pink/026.jpg
				sharp Hah... Exhausted yet? Or do I need to teach you another lesson about respect?
				pink K-kendra, I don't think this is a good idea.
				sharp Hmph. Why, because a crowd is gathering? I'll get to the rest of you shortly!
				scarf That all seems sound to me, naturally she'd need to satisfy everyone around her, but she certainly would have taught them a lesson by the end.
				principal I can't... I couldn't watch, I had to get out of there...
			`);
			break;
		}
		case "principalSharp2": {
			writeHTML(`
				scarf But you had to come back eventually, didn't you? Surely you don't think she just gave up.
				president No, she was headstrong, she would never have...
				scarf And of course, you went to check on her, to make sure your friend was okay. What did you see?
				t ...
				pink Kendra!
				im images/pink/028.jpg
				sharp What is it, principalF? I'm busy!
				pink These... How many of these student have you-
				sharp As many as it takes! Nghh~! Discipline is... Is...!
				im images/pink/029.jpg
				sharp Shhhhit! Too good!
				pink Gyaah!
				sharp N-now, who's next? If I see so much... As a hair out of place...
				scarf I think I get the picture, thank you. I'd imagine that this sort of thing happened often.
				principal I... Don't-
				scarf In fact it must have been a downright ordinary occurence. playerF, would you care to explore some other parts of the school now?
			`);
			break;
		}
		case "principalPhysical1": {
			writeHTML(`
				instructor So! You and the girls in the gym.
				principal Y-yes, after the event we reported-
				instructor Nope! That's not how it went down at all! You think you could get the top brass of the institution fired just because you ahd to wear a student's gym outfit? Let me tell you how it <i>really</i> happened!
				t ...
				pink W-what are you two doing?!
				sharp Calm down. A teacher should have dignity, even in embarassing situations.
				pink B-but this is too much!
				im images/pink/031.jpg
				oval Remember the plan, principalF, and relax! So we need to tempt some of the *boys a little, that's not too bad. 
				sharp And once they cross the line the current administration will be dead in the water. Imagine how the dean will react when we report what happened today.
				im images/pink/032.jpg
				pink Kyaaa! But now we're the ones crossing the line!
				oval Ooh, now we've really got their attention!
				im images/pink/033.jpg
				oval Over here! I bet you can't resist, huh?
				pink Maddy, st-
				sharp Shush principalF, don't scare *him away. We need hard evidence.
				im images/pink/034.jpg
				pink Ngggh!
				oval Oh wow, you're really stretching her!
				sharp Impressive. But is that all you can manage?
				t ...
				im images/pink/036.jpg
				pink W-why... Why am I the only one being used as bait...?
				oval principalF, we'd never abandon you! You were just going first!
				pink Eh?
				im images/pink/037.jpg
				oval Don't worry, we'll handle these next two. You take a breather and rest, okay?
				sharp We'll do more than our fair share, rest easy.
				pink B-but...
				im images/pink/038.jpg
				oval Haaaah~Mph~
				sharp Ah, you're bigger than the rest, aren't you?
				im images/pink/039.jpg
				instructor And then, and then Kendra said "Hey, you'd better switch with me! Or I'll"-
				principal No! That's not... What happened...!
				scarf Well, instructorF might be embellishing a little, but you were there, weren't you principalF?
				principal I... I was...
				scarf See?<br>playerF, instructorF, let's try and keep our stories a little more believable, yes?
				instructor Fiiiine.
			`);
			break;
		}
		case "principalPhysical2": {
			writeHTML(`
				instructor Alright, more believable...<br>Oh! So, what proof you had wasn't enough, right?
				principal It wasn't...? But why-
				instructor So, you had to take matters into your own hands!<br>Err, wait, believable... Okay! So, Maddy and Kendra had a plan, and you were such a pushover that...
				t ...
				pink This is a bad idea...
				oval Oh principalF, don't be such a downer!
				sharp She's right. We must stay composed. 
				im images/pink/040.jpg
				pink B-but organizing an event like this ourselves? How is meeting students in the gym half-naked like this going to help us?
				sharp Simple, we need the student's support if we want to oppose the senior faculty.
				oval And what better way is there to grow closer with the students?
				pink I...
				im images/pink/040left1.jpg
				oval Hah~! It's here, it's here~! I'm first~!
				sharp Grr...
				pink Wh-why are you letting this happen?! And Kendra, why are you angry?!
				im images/pink/040left2.jpg
				oval Hah~! My my, such a thick creampie!
				sharp Hey, over here, me next. If you're going to make me wait, you'd better give me a thicker load than hers.
				im images/pink/040right1.jpg
				sharp Hah~! Yes, just like that!
				pink W-why... Why is this happening...?
				im images/pink/040right2.jpg
				sharp Ffffuck~
				pink Oh... Oh no, no no no, you must be spent by now, right? So I'll just-
				im images/pink/040mid1.jpg
				pink Hiiii!
				oval Luckyyy! *He's going for a third round, we really lucked out on finding this one!
				im images/pink/040mid2.jpg
				pink Khhh... Why me...?
				scarf I... I'll say, instructorF, you certainly have enthusiasm.
				president At least it's sticking. We should move on from this one before principalF thinks about it too hard.
			`);
			break;
		}
		case "principalTeaching1": {
			writeHTML(`
				president You wanted nothing more than to be a good teacher.
				scarf You had such a bad habit of never saying no.
				nurse You just wanted to be loved, really.
				instructor So when some of the students started getting feisty...
				t ...
				im images/pink/051.jpg
				pink Now, can anyone come up here and solve this for me? Anyone at all? You, in the front!
				im images/pink/058.jpg
				pink Kyaaa~!
				president Right there, in front of the whole class.
				scarf But you couldn't move a muscle.
				pink W-why can't I-
				nurse Fear? Shock?
				instructor And because of that, you couldn't fight back when the prank went farther.
				im images/pink/059.jpg
				pink P-please, this isn't appropriate!
				president You said, but...
				scarf You couldn't find the strength to actually stop them, of course.
				im images/pink/060.jpg
				pink Khhh~!
				nurse Deeper and deeper, you'll keep sinking.
				president Until daylight is just a memory.
				scarf And these memories take firm root.
				im images/pink/060a.jpg
				scarf Relax~
				president And enjoy the ride~
			`);
			break;
		}
		case "principalMolested1": {
			writeHTML(`
				im images/pink/003.jpg
				pink L-let me go!
				nurse Now, you didn't want to see these misunderstood young students get expelled, so-
				principal What? Of course I did...!
				nurse Breath this, deeply.
				principal I... *huff*<br>Ohhh~
				scarf Tsk. Taking the easy way out.
				nurse Shush, this is my special skill. Now, principalF, relax, and tell me what happened that day.
				principal Eh... Ehehe~
				t ...
				im images/pink/003a.jpg
				pink Y-you silly kids, stop it already~<br>I'll get reeeeally mad~!
				player Are you... High? Drunk?
				nurse Little bit of column A, a lot of-<br>Ah! We should focus.
				im images/pink/004.jpg
				pink E-eh? Where'd my underwear go? This isn't good~! Did I drop it? Let me go for just a minute please~
				im images/pink/006.jpg
				pink Eh? Why's everybody...?
				nurse You just couldn't resist, could you? You were feeling so funny that day.
				principal Y-yesh... But! They went... Too far~!
				nurse Oh yes they did~
				im images/pink/007.jpg
				nurse You must have been so scared~! So many dominant, forceful facefuckings, and you barely had any time at all to brace yourself! And when they came~
				im images/pink/008.jpg
				nurse Oh, when they came~
				im images/pink/009.jpg
				pink Hah... Hah... You all... You made such a mess...! I'm gonna tell on you~!
				nurse But with every drop of that hot, creamy seed covering-
				president nurseF? Could you, um, calm it down a little?
				mama Is it getting hot in here?
				scarf It's not just you.
				nurse R-right. Well, this was a short-acting drug, so let's proceed.
			`);
			break;
		}
		case "principalMolested2": {
			writeHTML(`
				scarf But it wasn't enough.
				principal Eh?
				president Ah, it's wearing off. You remember being so dishearted, even though they'd gone so far, they didn't get expelled, isn't that horrible?
				principal It... It was... Why wasn't it enough?
				president But you had an idea, of course.
				nurse Take another deeeep breath, okay?
				t ...
				im images/pink/003a.jpg
				pink Y-you really can't keep doing this! I'll make a note on your perma... Permanent... Whatzit...? Kyaaa~!
				im images/pink/010.jpg
				nurse They pushed you down, and you were absolutely <i>soaked</i>... You just couldn't resist, could you?
				im images/pink/011.jpg
				nurse You wanted it. You <i>needed</i> it. Every second you didn't feel your cute little cunt getting railed you felt empty.
				president Oh my.
				mama I'm going to step out for just a minute...
				president Why? I don't mind watching.
				t ...
				im images/pink/013.jpg
				pink Hah... Hah...
				nurse And laying there, completely dressed in spunk, you, er-<br>Everyone?
...
var phoneArray = [//Lists the potential text events the player can receive at the start of the day, depending on their trust.
	{index: "council", requirements: "?counseling 5; !flag principal council; !mode carnivore;"},
...
function writePhoneEvent(name) { //Plays the relevant phone event
	switch (name) {
		...
		case "reward": {
			writePhoneImage("images/principal/reward.jpg", "Art by Oreteki18kin");
			writePhoneSpeech("principal", "", "Congratulations, you've gotten all three of principalF's endings, and beaten Hentai University! I hope you enjoyed!");
			break;
		}
		default: {
