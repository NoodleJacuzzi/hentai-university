...
var logbook = {
	...
	home: "vintageStreet",
	tags: "",
	artist: "Himitsu Kessha Vanitas<br>Original Image Set: Kyokon Zuki na Senpai ni Iiyorarete Muriyari SeFrie ni Sarete",
...
function writePhoneEvent(name) { //Plays the relevant phone event
	...
	switch (name) {
		case "swimmerreward": {
			...
			writePhoneSpeech("SlackerSavior","scripts/gamefiles/profiles/slacker","swimmerF's plot is over. Repeat scenes to come soon, and then, onto orangeF!");
			break;
		}
		case "swimmerphone1": {
			setTrust('swimmer', 51)
