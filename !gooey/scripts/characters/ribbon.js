...
var logbook = {
	...
	artist: "Oreteki18kin<br>Original Image Set: Himari-chan no XXX wa Ooisogashi!",
	...
	switch (name) {
		...
		case "ribbonRegret": {
			writeHTML(`
				...
				ribbon ojouF? Ohoh no, this is about your little voyeuristic adventures. I-<br>Oh darling, of course I knew! And the rest of my friends will too, unless you come by to pay me and my latest catch a visit~!
			`);
			writeFunction("writeEncounter('ribbonRegretLewd')", "Continue");
		}
		case "ribbonRegretLewd": {
			addFlag("ojou", "ribbonInvite");
			writeEvent("ribbonInviteLewd");
			passTime();
			writeFunction("changeLocation(data.player.location)", "Finish");
			break;
		}
		...
		case "ribbonQuo": {
			...
			if (checkFlag("ojou", "ribbonInvite") == true) {
				writeFunction("writeEncounter('ribbonInviteRepeat')", "Let's train ojouF again");
			}
			if (checkFlag("ojou", "ribbonInvite") == true && checkTrust("ojou") > 79) {
				writeFunction("writeEncounter('ribbonInvite2')", "Let's invite ojouF to a meeting");
			}
			if (checkFlag("ojou", "brownInvite") == true && checkFlag("ojou", "ribbonInvite") != true) {
				writeHTML(`
					ribbon My, it's quite lucky that ojouF hasn't been staying too long after class these days.
					t Since ojouF has already fallen prey to you, you don't need ribbonF to help you corrupt her. However, maybe a shock to the system from a trusted friend could be useful for ojouF's training...
				`);
				writeFunction("writeEncounter('ribbonRegret')", "Use ribbonF to help train ojouF.");
			}
...
var eventArray = [
	...
	{index: "ribbonInvite2", name: "A proper mouthfucking"},
];
	...
	switch (name) {
		...
		case "ribbonInviteLewd": {
			writeHTML(`
				...
				ojou Mmmgphh-!
				ribbon Hmm... But then you might lose focus on your *master's cock...<br>How about after? I know you'll be really horny, so-
				ojou Glllrk-! Hhhhhlrk-!
				ribbon Jeez, I can see he's cumming. No need to announce it for me. Listen, relax and smile, otherwise-
				im ribbonInvite8.jpg
				ojou Kkkllrk-!
		...
		case "ribbonInviteRepeat": {
			writeHTML(`
				im ribbonInvite1.jpg
				ribbon Ara~<br>It's hard to believe you haven't been totally broken-in yet. *His performance at the last club meeting was extraordinary, so I just can't fathom why... 
				im ribbonInvite2.jpg
				ribbon And it's not as though you're unreceptive.
				ojou S-stop, this is... Disgusting...
				ribbon Darling, there's simply no need to be so prudish! I consider myself a true modern hedonist, so believe me when I say you have a cunt I would simply die for!
				ojou ...
				ribbon Now then, don't be so dramatic, let's enjoy a meal together.
				im ribbonInvite3.jpg
				ribbon Our last dalliance was more of a teaching moment, so let's enjoy tonight together, an ordinary evening as friends.
				ojou Mmm... Some days I wonder if there's something wrong with your head...
				im ribbonInvite4.jpg
				ribbon Ah, the main dish!
				ojou Ghh, see! This is not normal! This isn't ordinary at all!	
				ribbon Darling! What century do you think we are in? We are in the prime of our youths, walking goddesses of fertility with flesh men would war over!<br>Thus, when a virile young *man offers us a delight, no matter how carnal, what on earth is the harm in sampling?
				ojou *He must be... Manipulating you somehow...
				ribbon Ara~ I'm sorry dear, but my club has been around longer than he has.<br>Oh, I just can't wait anymore~ 
				im ribbonInvite5.jpg
				t What follows is a blur of flesh and motion as you stake your claim upon the young girls' throats.
				im ribbonInvite6.jpg
				im ribbonInvite7.jpg
				im ribbonInvite8.jpg
				t And while it won't bring ojouF any closer to accepting her place, you and ribbonF clearly enjoyed yourselves.
			`);
			break;
		}
		case "ribbonInvite2": {
			writeHTML(`
				...
				ribbon Ara? A club meeting with a co-host? Well, I suppose there are some benefits, but I don't particularly enjoy sharing.
				player That's a little hypocritical.
				ribbon When you're as exceptional as I am, <i>you</i> can make the rules.
				t ...
				im 353.jpg
				ojou Nhooou~! Y-you sick... Perverts!
				im 348.jpg
				ribbon You know, I believe I'm coming around to this. Perhaps I'm more voyeuristic than I realized?<br>Well, only one way to find out. Another!
				ojou A-another? But I'm already-
				im 354.jpg
				t ojouF lets out a shrill gasp through her gritted teeth .
				ribbon Ah, I may have made a mistake. As co-host we ought to both be entertained, but I, with the greater stamina, am starting late... Well, nothing for it. Attend me, my little piglets~
				im 355.jpg
				ojou ...!
				t ...
				im 357.jpg
				ribbon Hah~ Hah~<br>My, I'm impressed you're still conscious... For someone who partakes so rarely, you've handled yourself well at the buffet, no?
				ojou N-no... I'm not like... Like...
				ribbon Darling, I appreciate the act, I do like a good show with my meal, but half the fluid you're adorned with is your own, maybe more.
				ojou Nghh...
				ribbon Mmm~! So full of naughty cum... Now then, piglets, you know how to pay tribute to us, yes? Don't disappoint~
				t The crowd begins to gather around ojouF and ribbonF.
				im 358.jpg
				t And begins to create quite the mess.
			`);
			break;
		}
		default: {
...
var phoneArray = [//Lists the potential text events the player can receive at the start of the day, depending on their trust.
	{index: "reward", requirements: "?flag ribbon ribbonInvite2;"},
]
