...
var logbook = {
	...
	artist: "Gujira<br>Original Image Set: Nameta Taido no Shounen to Icha Love Yagaix & Tsundere Kimono Shounen wa Nikubenki",
...
function writeEvent(name) { //Plays the actual event.
	...
	switch (name) {
		case "demonIntro1": {
			...
			writeSpeech("demon", "", "Aaah~ He wasn't exaggerating, it does have quite an incredible scent. Tell me, how does it feel being whored out?");
