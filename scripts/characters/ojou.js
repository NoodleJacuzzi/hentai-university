...
var logbook = {
	...
	artist: "Oreteki18kin<br>Original Image Set: Himari-chan no XXX wa Ooisogashi! & Futaba-chan Jusei Chu☆",
...
function writePhoneEvent(name) { //Plays the relevant phone event
	...
	switch (name) {
		case "reward": {
			...
			writePhoneSpeech("ojou", "", "You've fully corrupted ojouF! While she doesn't have a dedicated ending, new content is available with her and ribbonF / brownF!");
			break;
		}
		default: {
