...
var logbook = {
	...
	artist: "Oreteki18kin<br>Original Image Set: Ninkatsu Shichao! Ninshin Katsudou! & Haramitai! Natsu Nakadashi Kyouka Gasshuku",
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	writeHTML(`
		...
		define isf = sp instructor; im images/instructor/instructorP.jpg; ?flag instructor instructorFuck;
	...
	switch (name) {
		...
		case "corruption": {
			writeHTML(`
				...
				t ... That's probably your cue. You turn back to your partner for confirmation, and they nod.
	...
	switch (name) {
		case "instructortrackFuck": {
			writeHTML(`
				...
				incubus Hey, sorry to interrupt, but you should probably crash her train of thought. This magic's got its limitations and critical thinking is one of them.
