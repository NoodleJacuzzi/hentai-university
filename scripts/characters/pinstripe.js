...
var logbook = {
	...
	artist: "Enoshima Iki<br>Original Image Set: Yokkyuu Fuman no Kanjuku Onnakyoushi ni Yatto Kita Haru",
...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	{index: "intro", name: "You're walking down the hall, when...", requirements: "?trust pinstripe 0; ?location eastHallway; ?flag principal council;", altName: "", altImage: "",},
	...
	switch (name) {
		...
		case "pinstripeMouth": {
			writeHTML(`
				...
				...
				t Try as you might to question her afterwards it seems like the former pinstripeF is gone. Exactly what you'll do with her from now on is up in the air. Aside from drop by now and again to get your dick wet, of course.
			`);
			break;
		}
		case "pinstripePussy": {
