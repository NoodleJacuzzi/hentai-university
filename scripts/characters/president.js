...
var logbook = {
	...
	artist: "Oreteki18kin<br>Original Image Set: Suzuko-san wa Ochinchin ga Daisuki!",
	...
	switch (name) {
		...
		case "intro": {
			writeHTML(`
				...
				sp president; I'll be direct with you *sir, I've requested a more formal and transparent background check on you to be reviewed during the next PTSA meeting.<br>It's routine for all senior staff, but if you're going to be interacting so closely with my students you should be held to a higher standard.
		...
		case "tomgirlMeeting": {
			writeHTML(`
				...
				t tomgirlF was eager to help out, and now the pair sit across from each at a cafeteria table. She peppers him with questions about your methods, and he manages to not blow your cover.
...
var phoneArray = [//Lists the potential text events the player can receive at the start of the day, depending on their trust.
	//{index: "scenetypeTest", requirements: "?trust president 0;"},
