...
var encounterArray = [//Lists encounters as they appear on the map. Nonrepeatable, only one per day per character by default.
	...
	{index: "brownQuo", name: "brown is at her seat", requirements: "?trustMin brown 80; ?trustMax brown 100; ?location classroomB;", altName: "", altImage: "",},
	{index: "brownStoryQuo", name: "brown is at her seat", requirements: "?trustMin brown 101; ?location classroomB;", altName: "", altImage: "",},
];
...
function writeEncounter(name) { //Plays the actual encounter.
	...
	switch (name) {
		...
		case "bmomIntro": {
			var goof = {index: "bmom", fName: "Alexia", lName: "Wright", trust: 0, encountered: false, textEvent: "", met: false, color: "#C67D29", author: "NoodleJacuzzi", artist: "Oreteki18kin", textHistory: "", unreadText: false, gender:"female",};
		...
		case "brownStoryQuo": {
			...
			if (checkTrust("brown") > 102) {
				...
				writeText("brownF has an open notebook, it seems like she's been trying to keep track of your exploits. It's pretty empty so far, you should bring her to someone here at school.");
			}
			writeFunction("writeEncounter('cancel')", "Go back");
...
var eventArray = [
	...
	{index: "brown-president", name: "brownF & presidentF"},
	{index: "brown-purple", name: "brownF & purpleF"},
	{index: "brown-starlet", name: "brownF & starletF"},
	{index: "brown-instructor", name: "brownF & instructorF"},
];
